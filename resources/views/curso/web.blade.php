...
@section('titulo','Desenvolvimento Web | Eduz sua plataforma de cursos online')

@section('conteudo')
    <main role="main">
      <section id="curso" class="mt-5" style="background-color: orange;">
        <div class="container">
          <div class="curso-titulo p-4">
            <h1><span style="font-size: 22px; font-weight: 300;">Cursos de <br></span>Front End & Back End</h1>
      ...
      <section id="lista">
        <div class="container-fluid">
          <h1 class="h2 text-center mt-5"style="font-weight: 300" >Seja um desenvolvedor <strong>Front End & Back End!</strong></h1>
